...
const string strMessageMagic = "Cygnus Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 2137320 * COIN; return nSubsidy; 
	}
    ...
    else if(pindexBest->nHeight < 7501)
    {
        nSubsidy = 500 * COIN;
    }
    ...
    else if(pindexBest->nHeight < 15251)
    {
        nSubsidy = 2000 * COIN;
    }
    else if(pindexBest->nHeight < 20251)
    {
        nSubsidy = 1000 * COIN;
    }
	else if(pindexBest->nHeight < 25251)
    {
        nSubsidy = 500 * COIN;
    }
	else if(pindexBest->nHeight < 35251)
    {
        nSubsidy = 250 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Cygnus", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Cygnus was released on 23th of February 2016 ";
        CTransaction txNew;
        txNew.nTime = 1456241531;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("8ea7c24f6af579c1f5b968774d902fba8773ba692cb19703c3e9702e2ecbe087");
...
unsigned char pchMessageStart[4] = { 0xc2, 0xb3, 0xa1, 0xd4 };
